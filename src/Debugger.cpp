...
INT_PTR CALLBACK BreakpointProc (HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
        ...
        {
        case WM_INITDIALOG:
                SetWindowText(hwndDlg, Lang::GetString(LANG_DLG_BREAK_TITLE));
                SetDlgItemText(hwndDlg, IDOK,               Lang::GetString(LANG_DLG_OK));
                SetDlgItemText(hwndDlg, IDCANCEL,           Lang::GetString(LANG_DLG_CANCEL));
                SetDlgItemText(hwndDlg, IDC_BREAK_ENABLED,  Lang::GetString(LANG_DLG_BREAK_ENABLED));
                SetDlgItemText(hwndDlg, IDC_BREAK_EXEC,     Lang::GetString(LANG_DLG_BREAK_EXEC));
                SetDlgItemText(hwndDlg, IDC_BREAK_READ,     Lang::GetString(LANG_DLG_BREAK_READ));
                SetDlgItemText(hwndDlg, IDC_BREAK_WRITE,    Lang::GetString(LANG_DLG_BREAK_WRITE));
                SetDlgItemText(hwndDlg, IDC_BREAK_ACCESS,   Lang::GetString(LANG_DLG_BREAK_ACCESS));
                SetDlgItemText(hwndDlg, IDC_BREAK_OPCODE,   Lang::GetString(LANG_DLG_BREAK_OPCODE));
                SetDlgItemText(hwndDlg, IDC_BREAK_NMI,      Lang::GetString(LANG_DLG_BREAK_NMI));
                SetDlgItemText(hwndDlg, IDC_BREAK_IRQ,      Lang::GetString(LANG_DLG_BREAK_IRQ));
                SetDlgItemText(hwndDlg, IDC_BREAK_BRK,      Lang::GetString(LANG_DLG_BREAK_BRK));
                SetDlgItemText(hwndDlg, IDC_BREAK_SCANLINE, Lang::GetString(LANG_DLG_BREAK_SCANLINE));
                {
                        ...
                        while (hChild) {
                                ...
                                struct { const TCHAR *orig; LangStringID id; } labels[] = {
                                        { _T("Address"),    LANG_DLG_BREAK_ADDR     },
                                        { _T("Operation"),  LANG_DLG_BREAK_OP       },
                                        { _T("Time"),       LANG_DLG_BREAK_TIME     },
                                        { _T("&From"),      LANG_DLG_BREAK_FROM     },
                                        { _T("&To"),        LANG_DLG_BREAK_TO       },
                ...
                case IDOK:
                        ...
                        if (type & (DEBUG_BREAK_EXEC | DEBUG_BREAK_READ | DEBUG_BREAK_WRITE))
                        {
                                if ((addr1 < 0x0000) || (addr1 > 0xFFFF) ||
                                        ...
                                        (addr1 > addr2))
                                {
                                        MessageBox(hwndDlg, Lang::GetString(LANG_DBG_INVALID_ADDR), Lang::GetString(LANG_DLG_NINTENDULATOR), MB_ICONERROR);
                                        break;
                                }
                        }
                        if (type & (DEBUG_BREAK_OPCODE))
                        {
                                ...
                                {
                                        MessageBox(hwndDlg, Lang::GetString(LANG_DBG_INVALID_OPCODE), Lang::GetString(LANG_DLG_NINTENDULATOR), MB_ICONERROR);
                                        break;
                                }
                        }
                        if (type & (DEBUG_BREAK_SCANLINE))
                        {
                                ...
                                {
                                        MessageBox(hwndDlg, Lang::GetString(LANG_DBG_INVALID_SCANLINE), Lang::GetString(LANG_DLG_NINTENDULATOR), MB_ICONERROR);
                                        break;
                                }
...
INT_PTR CALLBACK CPUProc (HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
        ...
        {
        case WM_INITDIALOG:
                SetWindowText(hwndDlg, Lang::GetString(LANG_DLG_DBGCPU_TITLE));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_RUN,      Lang::GetString(LANG_DLG_DBGCPU_RUN));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_STEP,     Lang::GetString(LANG_DLG_DBGCPU_STEP));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_RESET,    Lang::GetString(LANG_DLG_DBGCPU_RESET));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_POWER,    Lang::GetString(LANG_DLG_DBGCPU_POWER));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_DUMPCPU,  Lang::GetString(LANG_DLG_DBGCPU_DUMPCPU));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_DUMPPPU,  Lang::GetString(LANG_DLG_DBGCPU_DUMPPPU));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_STARTLOG, Lang::GetString(LANG_DLG_DBGCPU_STARTLOG));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_STOPLOG,  Lang::GetString(LANG_DLG_DBGCPU_STOPLOG));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_SEEKPC,   Lang::GetString(LANG_DLG_DBGCPU_SEEKPC));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_SEEKTO,   Lang::GetString(LANG_DLG_DBGCPU_SEEKTO));
                SetDlgItemText(hwndDlg, IDC_DEBUG_CONT_SEEKSEL,  Lang::GetString(LANG_DLG_DBGCPU_SEEKSEL));
                SetDlgItemText(hwndDlg, IDC_DEBUG_BREAK_ADD,     Lang::GetString(LANG_DLG_DBGCPU_ADD));
                SetDlgItemText(hwndDlg, IDC_DEBUG_BREAK_EDIT,    Lang::GetString(LANG_DLG_DBGCPU_EDIT));
                SetDlgItemText(hwndDlg, IDC_DEBUG_BREAK_DELETE,  Lang::GetString(LANG_DLG_DBGCPU_DELETE));
                {
                        HWND hChild = GetWindow(hwndDlg, GW_CHILD);
                        while (hChild) {
                                TCHAR txt[64] = {0};
                                GetWindowText(hChild, txt, 64);
                                struct { const TCHAR *orig; LangStringID id; } labels[] = {
                                        { _T("Registers"),   LANG_DLG_DBGCPU_REGISTERS   },
                                        { _T("Timing"),      LANG_DLG_DBGCPU_TIMING      },
                                        { _T("IRQs"),        LANG_DLG_DBGCPU_IRQS        },
                                        { _T("Flags"),       LANG_DLG_DBGCPU_FLAGS       },
                                        { _T("Banks"),       LANG_DLG_DBGCPU_BANKS       },
                                        { _T("Breakpoints"), LANG_DLG_DBGCPU_BREAKPOINTS },
                                        { _T("Controls"),    LANG_DLG_DBGCPU_CONTROLS    },
                                        { _T("Memory"),      LANG_DLG_DBGCPU_MEMORY      },
                                        { _T("Trace"),       LANG_DLG_DBGCPU_TRACE       },
                                        { NULL, LANG_STRING_COUNT }
                                };
                                for (int k = 0; labels[k].orig != NULL; k++)
                                        if (_tcscmp(txt, labels[k].orig) == 0)
...
INT_PTR CALLBACK PPUProc (HWND hwndDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
        ...
        {
        case WM_INITDIALOG:
                SetWindowText(hwndDlg, Lang::GetString(LANG_DLG_DBGPPU_TITLE));
                SetDlgItemText(hwndDlg, IDC_DEBUG_PPU_TILEFLIP, Lang::GetString(LANG_DLG_DBGPPU_TILEFLIP));
                {
                        HWND hChild = GetWindow(hwndDlg, GW_CHILD);
                        while (hChild) {
                                TCHAR txt[128] = {0};
                                ...
                                struct { const TCHAR *orig; LangStringID id; } labels[] = {
                                        { _T("Nametable"),          LANG_DLG_DBGPPU_NAMETABLE },
                                        { _T("Sprites"),            LANG_DLG_DBGPPU_SPRITES   },
                                        { _T("Pattern Tables"),     LANG_DLG_DBGPPU_PATTERNS  },
                                        { _T("Palette"),            LANG_DLG_DBGPPU_PALETTE   },
                                        { _T("Details"),            LANG_DLG_DBGPPU_DETAILS   },
                                        { _T("Left-click to cycle palettes."), LANG_DLG_DBGPPU_CLICK },
                                        { _T("Hover cursor over item to view details.\nRight-click to remember selection."), LANG_DLG_DBGPPU_HOVER },
                                        { _T("Selection Type:"),    LANG_DLG_DBGPPU_SELTYPE   },
                                        { NULL, LANG_STRING_COUNT }
                                };
                                for (int k = 0; labels[k].orig != NULL; k++)
                                        if (_tcscmp(txt, labels[k].orig) == 0)
