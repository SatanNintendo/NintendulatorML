...
enum LangStringID
{
   ...
   LANG_MSG_NES_RESET_DONE,
    ...
    // ---------- HeaderEdit dialog ----------
    LANG_HDR_EDITOR_TITLE,
    LANG_HDR_ERR_REOPEN,
    LANG_HDR_ERR_OPEN,
    LANG_HDR_ERR_NOT_INES,
    LANG_HDR_ERR_DISKDUDE,
    LANG_HDR_ERR_DIRTY,

    // ---------- Controllers ----------
    LANG_CTRL_STD_UNCONNECTED,
    LANG_CTRL_STD_STDCONTROLLER,
    LANG_CTRL_STD_ZAPPER,
    LANG_CTRL_STD_ARKANOID,
    LANG_CTRL_STD_POWERPAD,
    LANG_CTRL_STD_FOURSCORE,
    LANG_CTRL_STD_SNES,
    LANG_CTRL_STD_VSZAPPER,
    LANG_CTRL_STD_SNESMOUSE,
    LANG_CTRL_STD_FOURSCORE2,
    LANG_CTRL_EXP_UNCONNECTED,
    LANG_CTRL_EXP_FAMI4PLAY,
    LANG_CTRL_EXP_ARKANOID,
    LANG_CTRL_EXP_FBKEY,
    LANG_CTRL_EXP_SUBORKEY,
    LANG_CTRL_EXP_FAMTRAINER,
    LANG_CTRL_EXP_TABLET,
    LANG_ERR_CTRL_INVALID_KEY,
    LANG_ERR_CTRL_INVALID_MOUSE,
    LANG_ERR_CTRL_DINPUT,
    LANG_ERR_CTRL_KEYBOARD,
    LANG_ERR_CTRL_MOUSE,
    LANG_ERR_CTRL_JOYSTICK,
    LANG_ERR_CTRL_COOP_MODIFY,
