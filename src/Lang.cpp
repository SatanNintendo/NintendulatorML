...
// ============================================================
// СТРОКИ ПО УМОЛЧАНИЮ (английские, встроенный запасной вариант)
// ============================================================
...
// ============================================================
// Таблица: ключ в .lng файле → LangStringID
// ============================================================
...
void Lang::Init(HINSTANCE hInst)
{
    ...
    {
        // Создать English.lng как шаблон
        TCHAR ep[MAX_PATH];
        _tcscpy(ep, LangDir);
...
{
    if (!hMenu) return;
    // Индексы: 0=File, 1=NES, 2=Settings, 3=Movie, 4=Debug, 5=Language, 6=Help
